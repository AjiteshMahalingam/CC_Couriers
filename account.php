...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-default navbar-light mb-10" style="background-color: rgba(255, 255, 255, 0.5);">
            <div class="container">
        ...
        <div class="container text-center" style="width : 50%; background-color: rgba(255, 255, 255, 0.5); margin-top: 10px; border-radius:15px; padding: 5px;">
